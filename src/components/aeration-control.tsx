      ...
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="relative w-full h-[600px]">
          <svg width="100%" height="100%" viewBox="0 0 800 600">
            ...
            {/* Air Path Arrows */}
            <polyline
              points="110,200 150,200 200,200 200,400 450,400"
              fill="none"
              stroke="#4B5563"
              strokeWidth="3"
            ...
            />
            <polyline
              points="450,400 500,400 500,150 400,150"
              fill="none"
              stroke="#4B5563"
              strokeWidth="3"
              markerEnd="url(#arrowhead)"
            />
            <polyline
              points="450,400 200,400 200,180 130,180"
              fill="none"
              stroke="#10B981"
              strokeWidth="3"
              markerEnd="url(#arrowhead)"
            ...
            />
            <path
              d="M450 365 Q460 375, 450 385 Q460 395, 450 405 Q440 395, 450 385 Q440 375, 450 365 Z"
              fill="#FFFFFF"
              stroke="#1F2937"
              strokeWidth="1"
              transform="rotate(45 450 385)"
            />
            <path
              d="M450 365 Q460 375, 450 385 Q460 395, 450 405 Q440 395, 450 385 Q440 375, 450 365 Z"
              fill="#FFFFFF"
            ...
            {isHeating && (
              <>
                ...
                <text
                  ...
                  textAnchor="middle"
                >
                  {HEATING_MODE_Set_Run_Duration || "N/A"} h
                </text>
              </>
            )}
            ...
            >
              {formatValue(
                data?.Running_time_hour || data?.RUNNING_HOUR1 || "0"
              )}
            </text>
            <text
              x="225"
            ...
            >
              {formatValue(
                data?.Running_time_minute || data?.RUNNING_MINUTE1 || "0"
              )}
            </text>
            <text
              x="185"
