...
export default function AutoPage() {
  ...
  const handleBack = () => {
    router.push(`/menu/${auto}`);
  };
  const [isAutoAeration, setIsAutoAeration] = useState(false);

  const handleToggleAutoAeration = (checked: boolean) => {
    setIsAutoAeration(checked);
  };
              ...
              <div className="relative w-full h-full">
                ...
                >
                  <Badge variant="outline" className="bg-background/80">
                    TH = {format(AI_TH_Act)} °C
                  </Badge>
                  <Badge variant="outline" className="bg-background/80">
                    T0 = {format(AI_AIR_OUTLET_TEMP)} °C
                  </Badge>
                  <Badge variant="outline" className="bg-background/80">
                    T1 = {format(AHT_PID_Config_OutputLowerLimit)} °C
                  </Badge>
                  <Badge variant="outline" className="bg-background/80">
