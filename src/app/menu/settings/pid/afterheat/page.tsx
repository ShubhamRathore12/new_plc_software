  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight mb-2">AFTERHEAT PID TUNING</h1>
        </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 items-center gap-2">
                      ...
                      <Input
                        ...
                        type="number"
                        value={params.th}
                        onChange={(e) => handleChange("th", Number.parseFloat(e.target.value) || 0)}
                        step={0.1}
                    ...
                    <div className="grid grid-cols-3 items-center gap-2">
                      ...
                      <Input
                        ...
                        type="number"
                        value={params.set}
                        onChange={(e) => handleChange("set", Number.parseFloat(e.target.value) || 0)}
                        step={0.1}
                        className="col-span-1"
                      />
                      <div>°C</div>
                    ...
                    <div className="grid grid-cols-3 items-center gap-2">
                      ...
                      <Input
                        ...
                        type="number"
                        value={params.vlv}
                        onChange={(e) => handleChange("vlv", Number.parseFloat(e.target.value) || 0)}
                        step={0.1}
                        className="col-span-1"
                      />
                      <div>%</div>
                    ...
                    <div className="grid grid-cols-3 items-center gap-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleChange("outHigh", Number.parseFloat(e.target.value) || 0)}
                        step={0.1}
                        className="col-span-1"
                      />
                      <div>%</div>
                    ...
                    <div className="grid grid-cols-3 items-center gap-2">
                      ...
                      <Input
                        ...
                        type="number"
                        value={params.outLow}
                        onChange={(e) => handleChange("outLow", Number.parseFloat(e.target.value) || 0)}
                        step={0.1}
                        className="col-span-1"
                      />
                      <div>%</div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 items-center gap-2">
                      ...
                      <Input
                        ...
                        type="number"
                        value={params.p}
                        onChange={(e) => handleChange("p", Number.parseFloat(e.target.value) || 0)}
                        step={0.1}
                        className="col-span-1"
                      />
                      <div></div>
                    ...
                    <div className="grid grid-cols-3 items-center gap-2">
                      ...
                      <Input
                        ...
                        type="number"
                        value={params.ti}
                        onChange={(e) => handleChange("ti", Number.parseFloat(e.target.value) || 0)}
                        step={0.1}
                        className="col-span-1"
                      />
                      <div>S</div>
                    ...
                    <div className="grid grid-cols-3 items-center gap-2">
                      ...
                      <Input
                        ...
                        type="number"
                        value={params.td}
                        onChange={(e) => handleChange("td", Number.parseFloat(e.target.value) || 0)}
                        step={0.1}
                        className="col-span-1"
                      />
                      <div>S</div>
            ...
            <Card className="h-full">
              <CardContent className="p-6 h-full">
                <div className="h-full flex flex-col">
                  <div className="text-lg font-semibold mb-4">Response Graph</div>
