...
export default function OutputsPage() {
  ...
  const getOutputsConfig = (deviceType: string) => {
    if (deviceType === "GTPL-122-gT-1000T-S7-1200" || deviceType === "GTPL-121-gT-1000T-S7-1200" || deviceType === "GTPL-133-GT-650T-S7-1200" || deviceType === "GTPL-131-GT-650T-S7-1200" || deviceType === "GTPL-081-GT-650T-S7-1200" || deviceType === "GTPL-105-GT-650T-S7-1200") {
      return [
  ...
  const getStatus = (dataKey: string) => {
    ...
    if (device === "GTPL-122-gT-1000T-S7-1200" || device === "GTPL-133-GT-650T-S7-1200" || device === "GTPL-131-GT-650T-S7-1200" || device === "GTPL-081-GT-650T-S7-1200" || device === "GTPL-105-GT-650T-S7-1200") {
