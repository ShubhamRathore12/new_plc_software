...
export default function InputsPage() {
  ...
  const isS7200 = device === "S7-200";
  const isS7100 = device === "S7-1200";
  ...
  const s7_1200_inputsData = [
    ...
    { id: "11.1", description: "Compressor circuit breaker fault", status: false },
    ...
    { id: "12.2", description: "Cond. fan circuit breaker fault", status: false },
