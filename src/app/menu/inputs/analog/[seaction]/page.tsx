...
export default function AnalogPage() {
  ...
  > = {
    ...
    "GTPL-068-GT-650T-S7-1200": sharedS7_1200_config,
    "GTPL-104-GT-650T-S7-1200": sharedS7_1200_config,
                    ...
                    <div className="grid gap-3">
                      {section.items
                        .filter((item) => {
                          ...
                          if (device === "GTPL-121-gT-1000T-S7-1200" || device === "GTPL-122-gT-1000T-S7-1200" || device === "GTPL-133-GT-650T-S7-1200" || device === "GTPL-081-GT-650T-S7-1200" || device === "GTPL-105-GT-650T-S7-1200" || device === "GTPL-131-GT-650T-S7-1200" || device === "GTPL-068-GT-650T-S7-1200" || device === "GTPL-104-GT-650T-S7-1200" || device === "GTPL-061-gT-450T-S7-1200") {
