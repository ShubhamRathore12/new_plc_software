...
export default function FaultPage() {
  ...
  // Map 'gptl-3o' (case-insensitive) to 'GTPL-114-gT-140E-P-S7-1200'
  const mappedFault =
    typeof fault === "string" && fault.trim().toLowerCase() === "gptl-3o"
      ? "GTPL-114-gT-140E-P-S7-1200"
      : fault;
  const { data, isConnected, error, formatValue } = useAutoData(
    mappedFault as string
  );
  ...
  const gtpl_117_faultTags = [
    ...
    {
      tag: "COND_FAN1_CIRCUIT_BREAKER_FAULT_I2_2",
      value: data?.Cond_fan1_circuit_breaker_fault_I2_2,
    },
    ...
    {
      tag: "COMPRESSOR_MOTOR_OVERHEAT",
      value: data?.Compressor_motor_overheat,
    },
    { tag: "HEATER_RCCB_FAULT", value: data?.Heater_RCCB_fault },
    {
      tag: "COND_FAN2_CIRCUIT_BREAKER_FAULT",
      value: data?.Cond_Fan2_circuit_breaker_fault,
    },
    {
      tag: "LOW_PRESSURE_FAULT_LOCKED",
      value: data?.Low_pressure_fault_Locked,
    ...
    {
      tag: "AMBIENT_TEMP_LESS_THAN_4C",
      value: data?.Ambient_temp_Less_than_4C,
    },
    { tag: "COND_FAN_1_TOP", value: data?.Cond_Fan_1_TOP },
    {
      tag: "COND_FAN1_CIRCUIT_BREAKER_FAULT",
      value: data?.Cond_Fan1_circuit_breaker_fault,
    },
    { tag: "COND_FAN_DRIVE_FAULT", value: data?.Cond_Fan_drive_fault },
    { tag: "COND_FAN_2_TOP", value: data?.Cond_Fan_2_TOP },
    {
      tag: "AMBIENT_TEMP_SENSOR_T2_1_OPEN",
      value: data?.Ambient_Temp_Sensor_T2_1_Open,
    },
    {
      tag: "AMBIENT_TEMP_SENSOR_T2_1_SHORT_CIRCUIT",
      value: data?.Ambient_Temp_Sensor_T2_1_Short_Circuit,
    },
    {
      tag: "AMBIENT_TEMP_SENSOR_T2_2_OPEN",
      value: data?.Ambient_Temp_Sensor_T2_2_Open,
    },
    {
      tag: "AMBIENT_TEMP_SENSOR_T2_2_SHORT_CIRCUIT",
      value: data?.Ambient_Temp_Sensor_T2_2_Short_Circuit,
    },
    {
      tag: "AIR_OUTLET_TEMP_SENSOR_T0_1_OPEN",
      value: data?.Air_Outlet_Temp_Sensor_T0_1_Open,
    },
    {
      tag: "AIR_OUTLET_TEMP_SENSOR_T0_1_SHORT_CIRCUIT",
      value: data?.Air_Outlet_Temp_Sensor_T0_1_Short_Circuit,
    },
    {
      tag: "AIR_OUTLET_TEMP_SENSOR_T0_2_OPEN",
      value: data?.Air_Outlet_Temp_Sensor_T0_2_Open,
    },
    {
      tag: "AIR_OUTLET_TEMP_SENSOR_T0_2_SHORT_CIRCUIT",
      value: data?.Air_Outlet_Temp_Sensor_T0_2_Short_Circuit,
    },
    {
      tag: "COLD_AIR_TEMP_SENSOR_T1_1_OPEN",
      value: data?.Cold_Air_Temp_Sensor_T1_1_Open,
    },
    {
      tag: "COLD_AIR_TEMP_SENSOR_T1_1_SHORT_CIRCUIT",
      value: data?.Cold_Air_Temp_Sensor_T1_1_Short_Circuit,
    },
    {
      tag: "COLD_AIR_TEMP_SENSOR_T1_2_OPEN",
      value: data?.Cold_Air_Temp_Sensor_T1_2_Open,
    },
    {
      tag: "COLD_AIR_TEMP_SENSOR_T1_2_SHORT_CIRCUIT",
      value: data?.Cold_Air_Temp_Sensor_T1_2_Short_Circuit,
    },
    {
      tag: "AIR_AFTER_HEATER_TEMP_SENSOR_TH_1_OPEN",
      value: data?.Air_After_Heater_Temp_Sensor_TH_1_Open,
    },
    {
      tag: "AIR_AFTER_HEATER_TEMP_SENSOR_TH_1_SHORT_CIRCUIT",
      value: data?.Air_After_Heater_Temp_Sensor_TH_1_Short_Circuit,
    },
    {
      tag: "AIR_AFTER_HEATER_TEMP_SENSOR_TH_2_OPEN",
      value: data?.Air_After_Heater_Temp_Sensor_TH_2_Open,
    },
    {
      tag: "AIR_AFTER_HEATER_TEMP_SENSOR_TH_2_SHORT_CIRCUIT",
      value: data?.Air_After_Heater_Temp_Sensor_TH_2_Short_Circuit,
    },
    { tag: "HIGH_PRESSURE_FAULT", value: data?.High_Pressure_Fault },
    { tag: "COMP_OIL_LOW", value: data?.Comp_Oil_Low },
    { tag: "HEATER_TOP_FAULT", value: data?.Heater_TOP_fault },
    { tag: "HEATER_DRIVE_FAULT", value: data?.Heater_drive_Fault },
    { tag: "CONDENSER_FAN2_DOOR_OPEN", value: data?.Condenser_fan2_door_open },
    { tag: "TH_TEMP_MORE_THAN_50C", value: data?.TH_Temp_more_than_50C },
    {
      tag: "DELTA_NOT_ACHIEVED_IN_AERATION_MODE",
      value: data?.Delta_not_achieved_in_aeration_mode,
    },
    {
      tag: "WARNING_LP_TRANSDUCER_FAILURE",
      value: data?.Warning_LP_transducer_failure,
    },
    {
      tag: "WARNING_HP_TRANSDUCER_FAILURE",
      value: data?.Warning_HP_transducer_failure,
    },
    {
      tag: "COND_FAN_DRIVE_CIRCUIT_BREAKER_FAULT",
      value: data?.Cond_fan_drive_circuit_breaker_fault,
    },
  ];
  ...
  const gpl_115_faultTags = [
    ...
    {
      tag: "COND_FAN_CIRCUIT_BREAKER_FAULT",
      value: data?.Cond_Fan_circuit_breaker_fault,
    },
    { tag: "COND_FAN_DRIVE_FAULT", value: data?.Cond_Fan_drive_fault },
  ...
  const gpl_117_machines = [
    "GTPL-117-gT-320E-S7-1200",
    "GTPL-116-gT-320E-S7-1200",
  ];

  const gpl_115_machines = [
    "GTPL-119-gT-320E-S7-1200",
    "GTPL-30-gT-180E-S7-1200",
  ];
  const normalizedFault = mappedFault?.toString().toUpperCase() || "";

  const isGPL_115 = gpl_115_machines.some((machine) =>
    normalizedFault.includes(machine.toUpperCase())
  );

  const isGPL_117 = gpl_117_machines.some((machine) =>
    normalizedFault.includes(machine.toUpperCase())
  );
  ...
  const isActiveTag = (value: any) => {
    ...
    return (
      normalized === "true" || normalized === "tr" || normalized === "True"
    );
  };
